...
namespace {
...
#if defined(CNL_MULTIWORD_ENABLED)
        static_assert(
                identical(
        ...
        static_assert(
                identical(
                        ...
                        cnl::_impl::binary_operator<
                                ...
                                cnl::_impl::duplex_integer<cnl::int8, cnl::uint8>>{}(0x1234, 0x5858)),
                "binary_operator<bitwise_and_op, duplex_integer<int8, uint8>, duplex_integer<int8, uint8>>");
    }
    ...
    namespace test_shift_left_op {
        static_assert(
                ...
                "cnl::_impl::duplex_integer<signed, unsigned> left shift");
        static_assert(
                identical(
        ...
        static_assert(
                identical(
                        ...
                        cnl::_impl::binary_operator<
                                ...
                                int>{}(0, 1)),
                "cnl::_impl::wide_integer<long, 4> right shift");
        static_assert(
                identical(
        ...
        static_assert(
                identical(
                        ...
                        cnl::_impl::binary_operator<
                                ...
                                cnl::_impl::duplex_integer<cnl::int8, cnl::uint8>,
                                cnl::_impl::duplex_integer<cnl::int8, cnl::uint8>>{}(0x8394uLL, 0)),
                "cnl::_impl::duplex_integer<signed, unsigned> right shift");
    }
