    ...
    namespace _impl {
        ...
        struct first_degree_binary_operator {
            ...
            -> _duplex_integer
            {
                return from_sums(
                        static_cast<Upper>(Operator{}(lhs.upper(), rhs.upper())),
                        Operator{}(wide_lower{lhs.lower()}, wide_lower{rhs.lower()}));
            }
        ...
        private:
            ...
            {
                return _duplex_integer(
                        static_cast<Upper>(cnl::_impl::sensible_left_shift(lhs.upper(), rhs))
            ...
            -> _duplex_integer
            {
                return _duplex_integer(
                        ...
                        static_cast<Lower>(sensible_right_shift(lhs.lower(), rhs)
                                | (rhs ? extra_sensible_right_shift(lhs.upper(), width<Lower>::value-rhs) : Lower{})));
            }
        };
